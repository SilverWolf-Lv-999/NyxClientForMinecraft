...
@ModuleInfo(name = "nyxclient.module.fakeplayer.name", description = "nyxclient.module.fakeplayer.description", category = Category.OTHER)
public class FakePlayer extends Module {
    public static final FakePlayer INSTANCE = new FakePlayer();

    private final StringValue name = ValueBuild.stringSetting("Name", "Nyx_Bot", this);
    private final BoolValue copyInventory = ValueBuild.boolSetting("Copy Inventory", true, this);
    private final BoolValue record = ValueBuild.boolSetting("Record", false, this);
    private final BoolValue playback = ValueBuild.boolSetting("Playback", false, this);
