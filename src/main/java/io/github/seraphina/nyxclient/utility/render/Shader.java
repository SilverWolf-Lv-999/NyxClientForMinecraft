package io.github.seraphina.nyxclient.utility.render;
...
public class Shader {
   ...
   private String read(String path) {
      try {
         return IOUtils.toString(Objects.requireNonNull(this.getClass().getResourceAsStream("/assets/nyxclient/shader/" + path)), StandardCharsets.UTF_8);
