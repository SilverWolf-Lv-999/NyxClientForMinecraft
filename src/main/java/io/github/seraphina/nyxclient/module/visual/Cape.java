package io.github.seraphina.nyxclient.module.visual;
...
@ModuleInfo(name = "nyxclient.module.cape.name", description = "nyxclient.module.cape.description", category = Category.PLAYER)
